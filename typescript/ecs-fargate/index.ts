...
import {EcsFargateStack, EcrEcsFargateStack, EcrEcsMultipleFargateElbStack, EcrEcsSingleFargateElbStack} from '../stacks';
...
new EcrEcsMultipleFargateElbStack(app, "EcrEcsFargateElb", params, {description: "ts-example: from defined docker with alb", env: params.env});
