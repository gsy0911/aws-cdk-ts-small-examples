...
import {EcsFargateStack, EcrEcsFargateStack, EcrEcsSingleFargateElbStack, EcrEcsMultipleFargateElbStack} from '../stacks';
...
new EcrEcsMultipleFargateElbStack(app, "EcrEcsMultipleFargateElb", params, {description: "ts-example: from defined docker with alb", env: params.env});
