import {
	...
	aws_ecs_patterns,
	aws_iam,
	aws_elasticloadbalancingv2 as aws_albv2
} from 'aws-cdk-lib';
...
export class EcrEcsMultipleFargateElbStack1 extends Stack {
	constructor(scope: Construct, id: string, props?: StackProps) {
		...
		const alb = new aws_albv2.ApplicationLoadBalancer(this, "ApplicationLoadBalancer", {
		...
		const targetGroupBlue = new aws_albv2.ApplicationTargetGroup(this, "http-blue-target", {
			vpc: vpc,
			targetGroupName: "http-blue-target",
			protocol: aws_albv2.ApplicationProtocol.HTTP,
			deregistrationDelay: Duration.seconds(30),
			targetType: aws_albv2.TargetType.IP,
